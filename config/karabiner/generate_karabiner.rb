...
def rules
  [
    ...
    rule("Hyper Key - System Navigation and Controls", [
          ...
          basic("Hyper + N: Move to space left", from: hyper("n"), to: [to_key("left_arrow", modifiers: ["right_control"])]),
          basic("Hyper + M: Move to space right", from: hyper("m"), to: [to_key("right_arrow", modifiers: ["right_control"])]),
